    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section"
            ...
            <div class="minting-container w-container">
                ...
                <form id="formSubtrair1" action="jogar" method="post" aria-label="Form"
                    onsubmit="localStorage.setItem('betInfluencer', 1)">
                    <div class="">
                ...
                <form id="formSubtrair2" action="jogar" method="post" aria-label="Form"
                    onsubmit="localStorage.setItem('betInfluencer', 2)">
                    <div class="">
                ...
                <form id="formSubtrair5" action="jogar" method="post" aria-label="Form"
                    onsubmit="localStorage.setItem('betInfluencer', 5)">
                    <div class="">
        ...
        <section id="mint" class="mint-section wf-section">
            <div class="minting-container w-container">
                ...
                <h2>SubwayPay</h2>
                <p class="paragraph">Bem-vindo ao mundo emocionante de SubwayPay! Prepare-se para uma aventura
                    eletrizante nos trilhos, onde cada curva guarda a promessa de fortuna. Desvie dos obstáculos, colete
                    moedas reluzentes e desbloqueie novos percursos enquanto corre em busca da riqueza. Sua jornada pela
                    cidade começa agora – acelere, desfrute e acumule sua fortuna nos trilhos de SubwayPay!. </p>
    ...
    <div id="faq" class="faq-section">
        <div class="faq-container w-container">
            ...
            <div class="question first">
                ...
                <h3>Como funciona?</h3>
                <div>SubwayPay é o mais novo jogo divertido e lucrativo da galera! Lembra daquele joguinho de surfar por
                    cima dos trens que todo mundo era viciado? Ele voltou e agora dá para ganhar dinheiro de verdade,
                    mas cuidado com os obstáculos para você garantir o seu prêmio. É super simples, surf, desvie dos
                    obstáculos e colete seus prêmios. </div>
            </div>
            <div class="question">
                <img src="arquivos/60fa0061a0450e3b6f52e12f_Body.svg" loading="lazy" width="90" alt="">
                <h3>Como posso jogar?</h3>
                <div class="w-richtext">
                    <p>Você precisa fazer um depósito inicial na plataforma para começar a jogar e faturar. Lembrando
            ...
            <div class="question">
                ...
                <p>O saque é instantâneo. Utilizamos a sua chave PIX como CPF para enviar o pagamento, é na hora e no
            ...
            <div class="question">
                ...
                <div>
                    <b>Não</b>! SubwayPay é totalmente diferente, basta apenas estar atento para desviar dos obstáculos
                    na hora certa. Não existe sua sorte em jogo, basta ter foco e completar o percurso até resgatar o
                    máximo de moedas que conseguir.
                </div>
            </div>
            <div class="question">
                ...
                <div class="w-richtext">
                    <ul role="list">
                        <li>
                            <strong>Jogatina</strong>. Quanto mais você correr, mais moedas você coleta e mais dinheiro
                            você ganha. Mas cuidado! Há trens escondidas entre as ruas.
                        </li>
                        <li>
                            <strong>Torneios</strong>. Além disso, você pode competir com outros jogadores em torneios e
                            desafios diários para ver quem consegue a maior pontuação e fatura mais dinheiro. A emoção
                            da competição e a chance de ganhar grandes prêmios adicionam uma camada extra de adrenalina
                            ao jogo.
                        </li>
                    </ul>
                    <p>Clique <a href="https://t.me/">aqui</a> e acesse nosso grupo no Telegram para participar de
                        eventos exclusivos. </p>
                </div>
            </div>
            <div class="question last">
                ...
                <div class="w-richtext">
                    <p>Chame um amigo para jogar e após o depósito e a primeira partida será creditado em sua conta R$5
