...
<html lang="pt-br" class="w-mod-js w-mod-ix wf-spacemono-n4-active wf-spacemono-n7-active wf-active">
  <head>
    ...
    <link rel="stylesheet" href="arquivos/css" media="all"> <?php
        include '../pixels.php';
        ?>
  </head>
  <body>
    ...
    window.onload = function() {
      ...
      <section id="mint" class="mint-section wf-section">
        <div class="minting-container w-container">
          ...
          <h2>SubwayPay</h2>
          <p class="paragraph">Bem-vindo ao mundo emocionante de SubwayPay! Prepare-se para uma aventura eletrizante nos trilhos, onde cada curva guarda a promessa de fortuna. Desvie dos obstáculos, colete moedas reluzentes e desbloqueie novos percursos enquanto corre em busca da riqueza. Sua jornada pela cidade começa agora – acelere, desfrute e acumule sua fortuna nos trilhos de SubwayPay!. </p>
    ...
    <div id="faq" class="faq-section">
      <div class="faq-container w-container">
        ...
        <div class="question">
          ...
          <div>
            <b>Não</b>! SubwayPay é totalmente diferente, basta apenas estar atento para desviar dos obstáculos na hora certa. Não existe sua sorte em jogo, basta ter foco e completar o percurso até resgatar o máximo de moedas que conseguir.
          </div>
        </div>
        <div class="question">
        ...
        <div class="question last">
          ...
          <div class="w-richtext">
            ...
            <ol role="list">
              ...
              <li>Você não pode criar novas contas na SubwayPay e se inscrever através do seu próprio link para receber a recompensa. O programa Indique um Amigo é feito para nossos jogadores convidarem amigos para a plataforma SubwayPay. Qualquer outro uso deste programa é estritamente proibido. </li>
            </ol>
            <p>‍</p>
          </div>
        </div>
