            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div>
                    <div class="text-center pt-3 pb-3">
                        <span class="db">
                            <img src="https://daanrox.com/assets/image/rox-footer.png" alt="logo" width="90" height="90"
                                class="rotate-image" />
                        </span>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" placeholder="Email"
                                        aria-label="Email" name="email" id="email" aria-describedby="basic-addon1"
                                        required />
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg" placeholder="Password"
                                        id="senha" name="senha" aria-label="Password" aria-describedby="basic-addon1"
                                        required />
                                </div>
                            </div>
                        </div>
