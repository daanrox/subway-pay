            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="GGR"
                                aria-expanded="false"><i class="mdi mdi-margin"></i><span
                                    class="hide-menu">GGR</span></a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="depositos"
                                aria-expanded="false"><i class="mdi mdi-cash"></i><span
                                    class="hide-menu">Depositos</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="saques"
                                aria-expanded="false"><i class="mdi mdi-cash"></i><span
                                    class="hide-menu">Saques</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="pixels"
                                aria-expanded="false"><i class="mdi mdi-code-tags"></i><span
                                    class="hide-menu">Pixels</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="./gateway"
                                aria-expanded="false"><i class="mdi mdi-cash"></i><span
                                    class="hide-menu">Gateway</span></a>
                        </li>
                        <li class="sidebar-item">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="planos"
                                aria-expanded="false"><i class="mdi mdi-square-inc-cash"></i><span
                                    class="hide-menu">Afiliados</span></a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="https://wa.me/5531992812273?text=Preciso+de+suporte+com+o+painel+adm"
                                target="_blank" aria-expanded="false"><i class="mdi mdi-message"></i><span
                                    class="hide-menu">Suporte</span></a>
                        </li>
                        <li class="sidebar-item p-3">
                            <a href="/adm/logout.php" class="
                w-100
                btn 
                d-flex
                align-items-center
                text-white
              " style="background-color: #ff7c6b"><i class="mdi mdi-logout font-20 me-2"></i>Sair</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <div class="card">
                    ...
                    <ul class="list-style-none">
                        <li class="d-flex no-block card-body">
                            ...
                            <div>
                                <a href="#" class="mb-0 font-medium p-0">Atualizacão do Sistema de afiliados</a>
                                <span class="text-muted">Sistema em atualização</span>
                            </div>
                            <div class="ms-auto">
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <form action="/adm/processos.php?opcao=depositoMin" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                                    value="<?php echo $result['deposito_min'] ?>" id="valorApostaMax"
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <h7 class="text-white">R$:</h7>
                                            <form action="/adm/processos.php?opcao=saqueMin" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                                    value="<?php echo $result['saques_min'] ?>" id="valorSaqueMin"
                                                    placeholder="Digite o valor" name="valor" required>
                                                <br>
                                                <br>
                                                <button type="submit" class="btn btn-primary">Atualizar</button>
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <h7 class="text-white">R$:</h7>
                                            <form action="/adm/processos.php?opcao=apostaMax" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                                    value="<?php echo $result['aposta_max'] ?>" id="valorSaqueMin"
                                                    placeholder="Digite o valor" name="valor" required>
                                                <br>
                                                <br>
                                                <button type="submit" class="btn btn-primary">Atualizar</button>
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <h7 class="text-white">R$:</h7>
                                            <form action="/adm/processos.php?opcao=apostaMin" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                                    value="<?php echo $result['aposta_min'] ?>" id="valorSaqueMin"
                                                    placeholder="Digite o valor" name="valor" required>
                                                <br>
                                                <br>
                                                <button type="submit" class="btn btn-primary">Atualizar</button>
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <form action="/adm/processos.php?opcao=rolloverSaque" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                ...
                                <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
                                    <div class="card card-hover">
                                        <div class="box bg-dark text-center">
                                            ...
                                            <h7 class="text-white">R%</h7>
                                            <form action="/adm/processos.php?opcao=taxaSaque" method="post"
                                                id="editForm3">
                                                <input type="text" class="form-control custom-input"
                                                    value="<?php echo $result['taxa_saque'] ?>" id="valorSaqueMin"
                                                    placeholder="Digite o valor" name="valor" required>
                                                <br>
                                                <br>
                                                <button type="submit" class="btn btn-primary">Atualizar</button>
