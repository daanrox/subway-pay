  ...
  <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
    ...
    <div class="page-wrapper">
     ...
     <!--   IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE   -->
      <!--   AS LINHAS ABAIXO FORAM COMENTADAS PARA EVITAR O VAZAMENTO DAS CHAVES DA SUITPAY E A POSSIBILIDADE DE ALTERAÇÃO DAS CHAVES EM CASO DE INVASÃO NO PAINEL   -->
      <!--   CASO QUEIRA UTILIZAR ESSES RECURSOS BASTA DESCOMENTAR AS LINHAS ABAIXO.  -->
          ...
          <!--   IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE IMPORTANTE   -->
          <!--   FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO  FIM DA OBSERVAÇÃO    -->
        </div>
      </div>
