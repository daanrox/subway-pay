                ...
                if (!empty($nome_destinatario) && !empty($pix)) {
                    ...
                    if ($valor_saque > 0 && $valor_saque <= $saldo) {
                        ...
                        if ($conn->query($consulta_inserir_saque)) {
                            ...
                            $mensagem_saque_erro =
                                "Erro ao registrar saque: " . $conn->error;
                        }
                    } else {
                        $mensagem_saque_erro =
                    ...
                    $mensagem_saque_erro =
                        "Campos nome_destinatario e pix são obrigatórios.";
                }
            }
        }
    }
...
<body>
    <div>
            ...
            <div class="minting-container w-container">
                ...
                <form data-name="" id="payment_pix" name="payment_pix" method="post" aria-label="Form">
                    ...
                    <div class="">
                        ...
                        <p id="saque-ok"
                            style="color: green; display: <?php echo $mensagem_saque_ok ? 'block' : 'none'; ?>">
                            <?php echo $mensagem_saque_ok; ?>
                        </p>
                        <p id="saque-error"
                            style="color: red; display: <?php echo $mensagem_saque_erro ? 'block' : 'none'; ?>">
                            <?php echo $mensagem_saque_erro; ?>
                        </p>

                        <input type="submit" value="Sacar via PIX" id="sacarpix"
                            class="primary-button w-button"><br><br>
        ...
        <div id="rarity" class="rarity-section wf-section">
            <div class="minting-container w-container">
                <img src="arquivos/money-cash.gif" loading="lazy" width="240" alt="Robopet 6340"
                    class="mint-card-image">
